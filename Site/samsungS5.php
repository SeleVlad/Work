        ...
        <div class ="main_wrap">
        	<div class = "main">
				...
				/*if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
				{
					...
					echo '<form method="post" action="cart_update8.php">';
					...
					echo '<td colspan="4">';
					echo '<button type="submit">Update</button><a href="view_cart8.php" class="button">Checkout</a>';
					echo '</td>';
					echo '</tbody>';
					echo '</table>';
...
$results = $mysqli->query("SELECT numeMarca,numeModel, pret, imagine, culoare, spatiu, dimensiune, memorieRAM,idProdus, procesor, camera,stoc
						...
						WHERE produs.idMarca = marca.idMarca AND produs.idProdus=8
...
$products_item .= <<<EOT
	<li class="product">
	<form method="post" action="cart_update8.php">
