        ...
        <div class ="main_wrap">
        	<div class = "main">
				...
				/*if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
				{
					...
					echo '<form method="post" action="cart_update9.php">';
					...
					echo '<td colspan="4">';
					echo '<button type="submit">Update</button><a href="view_cart9.php" class="button">Checkout</a>';
					echo '</td>';
					echo '</tbody>';
					echo '</table>';
...
$results = $mysqli->query("SELECT numeMarca,numeModel, pret, imagine, culoare, spatiu, dimensiune, memorieRAM,idProdus, procesor, camera,stoc
						...
						WHERE produs.idMarca = marca.idMarca AND produs.idProdus=9
...
$products_item .= <<<EOT
	<li class="product">
	<form method="post" action="cart_update9.php">
	<div class="product-content"><h3>Samsung {$obj->numeModel}</h3>
	<div>Spatiu: 16</div>
  	<div>Dimensiune: 4.3</div>
  	<div>Memorie Ram: 1 GB</div>
 	<div>Model Procesor: Dual-core 1.5 GHz Krait</div>                                                                    
  	<div>Camera: 8 MP</div>
	<div>OS: Android</div>
