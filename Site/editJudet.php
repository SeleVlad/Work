    ...
    <body>
        ...
        <div class ="main_wrap">
        	<div class = "main">
            	...
            	<p>
                <form  action ="editJudet.php" method="post">
                ...
                <?php 
						...
						$res= mysql_query("SELECT * FROM utilizator WHERE numeCont='$cnt' ");
						
						
						while($emp = mysql_fetch_assoc($res))
						{
							$telefon = $emp['idUtilizator'];
					
						}
						
						$sql     = "UPDATE utilizator SET Judet='$newName' WHERE idUtilizator='$telefon' ";
						$res 	 = mysql_query($sql) 
