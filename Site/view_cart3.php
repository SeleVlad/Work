...
/* 		$grand_total = $total + $shipping_cost; //grand total including shipping cost
		...
		$shipping_cost = ($shipping_cost)?'Shipping Cost : '. sprintf("%01.2f", 15.0).'<br />':'';
		$grand_total = $total + 15.0;
	}
    ?>
    <tr><td colspan="5"><span style="float:right;text-align: right;"><?php echo $shipping_cost; ?>Amount Payable : <?php echo sprintf("%01.2f", $grand_total) . $currency;?></span></td></tr>
    <tr><td colspan="5">
...
$res = mysql_query($q1);
 ...
 if (isset($_POST ['sub1'])){
								$insert=mysql_query("INSERT INTO coscumparaturi VALUES('', '1', '".$id."')");
